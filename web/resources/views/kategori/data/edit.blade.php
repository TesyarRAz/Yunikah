...
<div class="container h-100">
    <div class="row align-items-center h-100">
        <div class="col-md-5 col-12 mx-auto">
            <div class="card p-3">
                <h2 align="center">Edit Pilihan {{ $kategori->name }}</h2>

                <form enctype="multipart/form-data" class="form-group my-5" action="{{ route('kategori.data.update', [request()->jenis, $kategori, $data->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" required autocomplete="keterangan" autofocus>{{ old('keterangan') ?? $data->keterangan }}</textarea>
